    ...
    <div class="container">
        <div class="row">
            <div class="footer_link">
                <small>本博客是博主使用yii2框架自主开发而成，但由于能力有限，不足之处还望指出，同时希望与大家多多交流。</small>

            </div>
            <div class="footer_link">
                <ul class="list-inline text-center">
                    <li><b>友情链接:</b></li>
                    <li><a href="http://blog.duicode.com">怼码人生</a></li>
                    <li><a href="http://www.yiichina.com">Yii中文网</a></li>
                    <li><a href="https://git.oschina.net">码云</a></li>
                </ul>
                <!--<ul class="list-inline text-center">
